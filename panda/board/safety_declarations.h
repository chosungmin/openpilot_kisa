...
extern const safety_hooks hyundai_community1_hooks;
extern const safety_hooks hyundai_community2_hooks;
extern const safety_hooks hyundai_community1_legacy_hooks;
